// sincere thanks to viral science
// uploaded to esp8266 12e small(not the node mcu board)
...
#define AUTH "AUTHENTICATION TOKEN FROM BLYNK APP"  // You should get Auth Token in the Blynk App.  
#define WIFI_SSID "WIFI SSID"  //Enter Wifi Name
#define WIFI_PASS "YOUR NETWORK PASSWORD"  //Enter wifi Password

//#define SERVER "blynk-cloud.com "             // Comment-out if use Blynk hosted cloud service
//#define PORT 8442
// ESP8266 pins for relay board 
#define RELAY_PIN_1       1   //TX 
#define RELAY_PIN_2       5   //D1
#define RELAY_PIN_3       4   //D2
#define RELAY_PIN_4       2   //D4 
// ESP8266 pins for buttons
#define PUSH_BUTTON_1    16   //D0
#define PUSH_BUTTON_2    14   //D5
#define PUSH_BUTTON_3    12   //D6
#define PUSH_BUTTON_4    13   //D7

// Define these vitula pins in blynk app
#define VPIN_BUTTON_1    V12 
#define VPIN_BUTTON_2    V13
#define VPIN_BUTTON_3    V14
#define VPIN_BUTTON_4    V15  

#define OTA_HOSTNAME "Home_Automation"  // you can name it whatever you like
...
void setup()
{
  ...
  Serial.begin(115200);
  Blynk.begin(AUTH, WIFI_SSID, WIFI_PASS, IPAddress(192,168,121,118), 8080);
